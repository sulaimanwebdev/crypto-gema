      ...
      <div className="mx-auto max-w-[1300px] px-5">
         ...
         <div className="max-w-[500px] mx-auto mt-12 px-5">
          ...
          <div className="entering-card rounded-xl px-10 pt-8 pb-8 text-white">
           ...
           <div className="flex justify-end mt-5"><div className="bg-white w-fit px-3.5 py-1.5"><button className='button-shadow font-[700] bg-white text-[17px] py-2 px-7 text-[#3E3E3E]'>Login</button></div></div>
           </form>
