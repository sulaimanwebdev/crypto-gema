    ...
    <div className="card-shadow bg-[#F6F6F6] w-full rounded-xl pt-10 pb-8 px-5">
               <div className="flex items-center justify-center gap-[100px]">
                  <div className="flex items-center gap-5">
                    ...
                    <div className="rounded-full bg-white border w-[50px] h-[30px]"></div>
                    <div className={`rounded-full bg-[${props.enteringColor}] border w-[50px] h-[30px]`}></div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-5">
                    ...
                    <div className="flex items-center gap-2">
                    <div className="rounded-full bg-white border w-[50px] h-[30px]"></div>
                    <div className={`rounded-full bg-[${props.closeTo}] border w-[50px] h-[30px]`}></div>
                    <div className="rounded-full bg-white border w-[50px] h-[30px]"></div>
                    </div>
                  </div>
               </div>
               ...
               <div className="flex items-center justify-center gap-[100px] mt-7">
                  ...
                  <div className="flex items-center gap-5">
                    ...
                    <div className="flex items-center gap-2">
                    <div className={`rounded-full bg-[${props.out}] border w-[50px] h-[30px]`}></div>
                    <div className="rounded-full bg-white border w-[50px] h-[30px]"></div>
                    <div className="rounded-full bg-white border w-[50px] h-[30px]"></div>
                    </div>
                  </div>
               ...
               <div className={`rounded-full bg-[${props.enteringColor}] border w-[45px] h-[30px]`}></div>
               </div>

               <div className="flex items-center gap-5">
               <div className="text-[19px] text-gray-900 font-[400]">Close to</div>
               <div className={`rounded-full bg-[${props.closeTo}] border w-[45px] h-[30px]`}></div>
               </div>

               <div className="flex items-center gap-5">
               <div className="text-[19px] text-gray-900 font-[400]">Out</div>
               <div className={`rounded-full bg-[${props.out}] border w-[45px] h-[30px]`}></div>
               </div>
