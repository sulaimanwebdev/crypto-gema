...
const Entering = ({data}) => {
  ...
  return (
    <>
      <div className="entering-card rounded-xl px-5 pt-7 pb-7 text-white">
        <div className="flex items-center gap-5">
            <div className='text-[28px] font-[700]'>Entering</div>
        ...
        <div className="w-full grid grid-cols-3 gap-3 border-b-2 border-white pb-2 mt-8 mb-2">
            <div className='flex items-center justify-center text-[18.5px]'>Symbol</div>
            <div className='flex items-center whitespace-nowrap justify-center text-[18.5px]'>Entry Point</div>
            <div className='flex items-center justify-center text-[18.5px]'>Type</div>
        </div>
        {
          data.slice(0,3).map((ele)=>{
            return(
              ...
              <div className='flex items-center justify-center text-[15.5px]'>{ele.type}</div>
            </div>
            )
          })
        }
